...
grkern2fea -s strings -e lookups -i $outdir/rawPairData-Regular-nozwj.txt -f results/Harmattan-Regular.ttf  -r ${R:=20} -R $outdir/caKern-Regular.fea             ; \
...
grkern2fea -s strings -e lookups -i $outdir/rawPairData-Bold-nozwj.txt     -f results/Harmattan-Bold.ttf  -r ${R:=20} -R $outdir/caKern-Bold.fea             ; \
