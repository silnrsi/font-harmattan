...
( grkern2fea -e graphite -i source/kerndata.ftml -F nu53=1      -f results/Harmattan-Regular.ttf                 $outdir/rawPairData-Regular.txt        ; \
...
( grkern2fea -e graphite -i source/kerndata.ftml -F nu53=1      -f results/Harmattan-Bold.ttf                 $outdir/rawPairData-Bold.txt        ; \
