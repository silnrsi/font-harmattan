...
tools/absgenftml.py -q -t "Feature-Language Interactions (auto)" source/masters/Harmattan-Regular.ufo  tests/FeatLang-auto.ftml        -l tests/logs/FeatLang.log  "${commonParams[@]}" -s "url(../results/Harmattan-Bold.ttf)|Bold"  &
