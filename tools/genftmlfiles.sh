...
tools/absgenftml.py -q -t 'DiacTest1 (NG)'        source/Harmattan-Regular.ufo  tests/DiacTest1.ftml       -l logs/DiacTest1.log        -s 'url(../references/Harmattan-Regular-v1.ttf)=Reg ref' --ap "_?dia[AB]$" --xsl ../tools/lib/ftml.xsl --scale 250 -i source/glyph_data.csv --langs "sd,ur,ku,rhg,wo" -w 75% -s 'url(../results/Harmattan-Regular.ttf)=Reg-Gr' -s 'url(../results/tests/ftml/fonts/Harmattan-Regular_ot_arab.ttf)=Reg-OT' -s 'url(../results/Harmattan-Bold.ttf)=Bold-Gr' & 
